...
from models.Cell_DETR_modules.detr_new import CellDETR
from models.Cell_DETR_modules.segmentation import ResFeaturePyramidBlock, ResPACFeaturePyramidBlock

from models.utils.transformer import BoundaryAwareTransformer, Transformer
...
def cell_detr_128(pretrained=False, type_index=0):
    ...
    if pretrained:
        ckpt = torch.load("/home/chenfei/my_codes/TransformerCode-master/lib/Cell_DETR_master/trained_models/Cell_DETR_A/detr_99.pt")
