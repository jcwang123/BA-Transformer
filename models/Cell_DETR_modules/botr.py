...
sys.path.insert(0, '/home/wl/File/SegGTV/Ours/Cell_DETR_master/')
import torch
import numpy as np
...
class CellDETR(nn.Module):
    ...
    def forward(self, input: torch.Tensor, point: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
        bounding_box_attention_masks = self.segmentation_attention_head(
            latent_tensor, Feature.contiguous())
